      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 to-primary-800 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-white px-12">
          ...
          >
            ...
            <h1 className="text-4xl font-heading font-bold mb-4">PlaceMe</h1>
            ...
            <div className="space-y-4 text-left max-w-sm">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/90">AI-Powered Resume Analysis</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-white/90">Smart Eligibility Scoring</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-white/90">Connect with Top Recruiters</span>
              </div>
            </div>
          </motion.div>
